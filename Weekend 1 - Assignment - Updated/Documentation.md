...
Scene Scaling
    The original coordinate system (480×360) is scaled up proportionally to fit the browser window,
    ensuring consistent positioning across resolutions.
...
Sprite Animation System
    ...
    Note: The sprite sheet is dowanloaded fron online.