...
function preload() {
  ...
  spriteImage = loadImage('Images/160x160-bat-sprite-flying.png');
}
...
function draw() {
  ...
  let frame = frameCount%spriteX;
  image(sprites[row][frame],x,y);
  if(keyIsPressed) {
